      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
          ...
          <div className="space-y-4">
            <h3 className="text-2xl font-bold text-white">DocAI</h3>
            <p className="text-gray-400 text-sm">
              Lightning-fast AI-powered document processing. Extract text, analyze content, and transform your documents in seconds.
            </p>
            {/* Social Links */}
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li>
                <a href="#" className="hover:text-indigo-400 transition-colors">Integrations</a>
              </li>
              <li>
                <a href="#" className="hover:text-indigo-400 transition-colors">Changelog</a>
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li>
                <a href="#" className="hover:text-indigo-400 transition-colors">Press Kit</a>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li>
                <a href="#" className="hover:text-indigo-400 transition-colors">Report a Bug</a>
              </li>
            </ul>
          </div>
        </div>
